...
>>a. Inherits from Book: Has a parameterized constructor taking these  parameters:
>>>* string Title
>>>* string Author
>>>* int Price

>>b. Implements the Book class' abstract display() method so it prints the value of above parameters.
